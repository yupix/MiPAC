...
class SharedAdminRoleActions:
    ...
    async def update(
        ...
        iconUrl: str | None = MISSING,
        target: Literal["manual", "conditional"] = MISSING,
        cond_formula: dict[Any, Any] | None = MISSING,
        is_public: bool = MISSING,
        is_moderator: bool = MISSING,
        is_administrator: bool = MISSING,
        is_explorable: bool = MISSING,
        as_badge: bool = MISSING,
        can_edit_members_by_moderator: bool = MISSING,
        display_order: int = MISSING,
        policies: dict[Any, Any] | None = MISSING,
        *,
        role_id: str,
    ) -> bool:
